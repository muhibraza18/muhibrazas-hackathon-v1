...
const Footer = () => {
  return (
    <div className="w-full h-[400px]">
      <div className="w-full h-[400px] border-2 pt-20 pl-56 gap-20 xl:flex">
        <div className="first w-[350px] ">
        ...
        <div className="fourth text-lg w-[350px]">
